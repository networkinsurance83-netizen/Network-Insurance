...
- Facebook CTA: public website URL once deployed.
...
- Permanent public website URL for Facebook posts: `PENDING_PERMANENT_DEPLOYMENT`.
- Deployment: not deployed yet.

## Facebook CTA Rule

Network Insurance Facebook posts and Brad Smith Facebook posts about health coverage should send viewers to the public Network Insurance website URL once deployed.
...
Do not use the local `file://` website path in Facebook posts.

The temporary Cloudflare Tunnel URL can be used for short-term review/testing, but a permanent Cloudflare Pages or GitHub Pages URL is recommended before using the site as the long-term Facebook CTA.

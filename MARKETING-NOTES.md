...
These notes are internal and should not appear on public website pages.
...
- Deductibles, premiums, copayments, coinsurance, and out-of-pocket maximums.
...
- Marketplace financial assistance basics.
- Private coverage vs. Marketplace coverage.
- Understanding prescription formularies.
...
- Disability income protection basics.

## Lead Strategy

- Use educational posts to send visitors to the website.
- Encourage visitors to request a quote, request a review, or schedule a consultation.
- Do not promise savings, approval, eligibility, provider access, or coverage.
